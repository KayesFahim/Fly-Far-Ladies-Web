...
class OrderTransaction {
    ...
    public function saveTransactionQuery($post_data)
    {
        ...
        $sql = "INSERT INTO orders (name, email, phone, amount, address, status, pkId, transaction_id ,currency)
                                    VALUES ('$name', '$email', '$phone','$transaction_amount','$address','Pending','$pkId', '$transaction_id','$currency')";
